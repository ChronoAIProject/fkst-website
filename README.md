...
- The engine source pin remains `.fkst-substrate-ref`; the fkst-packages
  platform checkout is pinned by
...
To bump the shared ratchets, update the `fkst-packages-platform` rev in
`fkst.workspace.toml`, regenerate `fkst.lock`, remove
